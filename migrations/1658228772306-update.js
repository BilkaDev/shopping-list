...
exports.update1658228772306 = void 0;
var update1658228772306 = /** @class */ (function () {
    function update1658228772306() {
        this.name = 'update1658228772306';
    }
    update1658228772306.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE `product` DROP FOREIGN KEY `FK_329b8ae12068b23da547d3b4798`")];
                    case 1:
                        _a.sent();
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE `recipe` CHANGE `userId` `userId` varchar(36) NULL")];
                    case 4:
                        _a.sent();
    ...
    update1658228772306.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 14:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE `recipe` CHANGE `userId` `userId` varchar(36) NULL DEFAULT 'NULL'")];
                    case 15:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE `recipe` ADD CONSTRAINT `FK_fe30fdc515f6c94d39cd4bbfa76` FOREIGN KEY (`userId`) REFERENCES `user`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 16:
    ...
    return update1658228772306;
}());
exports.update1658228772306 = update1658228772306;
